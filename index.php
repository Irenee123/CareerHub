...
<head>
  ...
  <link rel="stylesheet"
        ...
        <style type="text/css">
        header.main-header {
  height: 80px; /* Keep the header height */
  background-color: #2e3b4e; /* Set the background color */
  color: #fff; /* Set text color */
  display: flex; /* Enable flexbox */
  align-items: center; /* Center items vertically */
  justify-content: space-between; /* Space out elements horizontally (optional) */
...
header.main-header .navbar a:hover {
  color: #d1d5db; /* Slightly lighter hover effect */
}
          ...
          */
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              <img class="attachment-img" src="css/img/photo1.png" alt="Attachment Image">
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="css/img/browse.jpg" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="css/img/interviewed.jpeg" alt="Apply & Get Interviewed">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="css/img/career.jpg" alt="Start A Career">
              <div class="caption">
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="css/img/postjob.png" alt="Browse Jobs">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="css/img/manage.jpg" alt="Apply & Get Interviewed">
              <div class="caption">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              <img src="css/img/hire.png" alt="Start A Career">
              <div class="caption">
